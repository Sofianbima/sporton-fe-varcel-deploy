...
const PaymentSteps = () => {
    ...
    return (
        <CardWithHeader title="Payment Steps">
               <div className="p-5">
                 <ol className="list-decimal text-xs pl-2 h-fit flex flex-col gap-4">
                    <li>
                ...
                <div className="border-t border-gray-200 p-4 mt-4 mb-0">
                    <div className="flex justify-between font-semibold mb-4">
                        ...
                        <div className="text-[#FF5F3F] text-xs ">
                            {priceFormatters(9800000)}
                        </div>
                    </div>
                </div>
                <button className="bg-black text-white w-full py-4 flex justify-center items-center gap-2 font-medium" onClick={uploadAndConfirm}>
